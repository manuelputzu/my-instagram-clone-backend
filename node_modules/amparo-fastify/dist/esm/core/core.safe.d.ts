 ...
 */
declare function safe<T>(value: Promise<T>, errorHandler: (error: any) => [errorMessage: string, errorName: ErrorName]): Promise<T>;
declare function safe<T>(value: Promise<T>, errorMessage: string, errorName: ErrorName): Promise<T>;
export { safe };
//# sourceMappingURL=core.safe.d.ts.map